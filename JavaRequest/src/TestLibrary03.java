...
public class TestLibrary03 {

	private static final String PREF_NAME = "TestLibraru03";
	...
	public static void main(String[] args) {
		...
		preferences.remove(COOKIES_VALUE);
			...
			System.out.println(preferences.get(COOKIES_KEY, "").isEmpty());
...
//		System.out.println(response.body());
	...
	// System.out.println(d.select(".span10 > userdetails.maincontent
	// >opac-user-views.toptabs").text());

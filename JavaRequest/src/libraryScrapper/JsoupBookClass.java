...
class JsoupBookClass {
	...
	public JsoupBookClass() {
	}

	public JsoupBookClass(Element image, Element title, Element author, Element due_date, Element bar_code, Element cell_no,
	...
	public String toString() {
		return "JsoupBookClass [image=" + image + ", title=" + title + ", author=" + author + ", due_date=" + due_date
